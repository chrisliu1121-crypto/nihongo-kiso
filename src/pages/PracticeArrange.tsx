// PracticeArrange — "/practice/arrange": the arrange-practice exercise list
// + player (DESIGN.md §3/§8.5, build task 2026-09 step 5). One question at a
// time with prev/next paging, same shell shape as DailyWords' date pager.
...
function isArrangeExercise(exercise: Exercise): exercise is ArrangeExercise {
  return exercise.type === "arrange";
}

export function PracticeArrange() {
  const exercises = bank.exercises.filter(isArrangeExercise);
  ...
  return (
    <div className="space-y-4">
      <header className="flex flex-wrap items-center gap-3">
        <h1 className="text-2xl font-bold text-stone-900">排列練習</h1>
